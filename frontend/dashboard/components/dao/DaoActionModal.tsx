...
export interface DaoActionModalProps {
  isOpen: boolean;
  title: string;
  description?: string;
  children: ReactNode;
  onClose: () => void;
  size?: "sm" | "md" | "lg";
  actions?: ReactNode; // Footer actions: buttons for submit/cancel, etc.
}

export const DaoActionModal: React.FC<DaoActionModalProps> = ({
  isOpen,
  title,
  description,
  children,
